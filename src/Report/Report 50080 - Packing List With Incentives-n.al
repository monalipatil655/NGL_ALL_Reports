report 50080 "Packing List With Incentives-n"
{
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            dataitem(DataItem8078; 50054)
            {
                DataItemTableView = SORTING("No.");
                RequestFilterFields = "No.";
                //ReqFilterHeading = 'Packing List Document';  //PCPL-25/020123
                ...
                dataitem(DataItem1535; 50055)//able33001048)
                {
                    ...
                    column(STRSUBSTNO___1___2__decNetWght_codWeightUOM_; STRSUBSTNO('%1  %2', decNetWght, codWeightUOM))
                    {
                        ...
                        // DecimalPlaces = 2 : 5;    //PCPL-25/020123
                    }
                    ...
                    begin
                        ...
                        IF "Line No." = 10000 THEN
                            ItemDesctext := ''//Marks //PCPL-25/020123
                        ELSE
                            ItemDesctext := '';
                       ...
                       */
                        ...
                        //cduEximMgmt.fctTotalConsolidatePkgs("No.", "Incentive Type", "Claim DDB", intTotalConsolidatePkgs);//PCPL-25/020123
                        recPackListPackageDetails.RESET;
                        recPackListPackageDetails.SETRANGE(recPackListPackageDetails."Packing List No.", "Packing List No.");
                ...
                dataitem(FixedLay; 2000000026)
                {
                    ...
                    // dataitem(DataItem1000000056; 280)
                    // {
                ...
                begin
                    ...
                    IF Status = Status::Shipped THEN BEGIN
                        ShipmentMethod := "Shipment Method Code";
                        SalesInvHeader.RESET;
                        SalesInvHeader.SETRANGE(SalesInvHeader."Order No.", "SO NO.");
                    ...
                    END;
                    // IF recPortsport.GET(Port) THEN
                    //     txtPortName := recPortsport."Port Name";     //PCPL-25/030123
                    ...
                    ELSE
                        //fctPackingListShptTo(txtShipToAddr, "Packing List Header");   //PCPL-25/030123
                        ...
                        // //PCPL0041-End-04022020          //PCPL-25/030123
                        ...
                        */
                        ...
                        //     txtPortofDischarge := recPorts."Port Name";  //PCPL-25/030123
    ...
    var
        ...
        Country: Record 9;
        Remarks: Text[250];
        //ProductGroup: Record "Product Group";//5723;        //PCPL-25/030123
        ItemDesctext: Text;
        ...
        ManuDate: Date;
        ShipmentMethod: Text;
        //recPortsport: Record 33001050;  33001050
        ...
        Descr2: Text;
        ItemNo: Code[55];
        RecPackingListHeader: Record 50054;//"33001046";
        RecPackingListPackDetail: Record 50055;//"33001048";
        PrevHSN: Text[100];
        HSNCode: Text[100];
        CounReg: Record 9;
    ...
    procedure fctPackingListSellTo(var PtxtAddrArray: array[8] of Text[90]; var PrecPackingList: Record 50054);//33001046);
    begin
    ...
    procedure fctPackingListShptTo(var PtxtAddrArray: array[8] of Text[90]; var PrecPackingList: Record 50054);//33001046);
    begin
        WITH PrecPackingList DO
            cduFormatAddr.FormatAddr(
    ...
    procedure fctPackingListBillTo(var PtxtAddrArray: array[8] of Text[90]; var PrecPackingList: Record 50054);//"33001046");
    begin
        WITH PrecPackingList DO
            cduFormatAddr.FormatAddr(
