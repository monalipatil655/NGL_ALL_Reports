...
{  //PCPL/NSW/MIG 09Aug22
    ...
    dataset
    {
        dataitem(DataItem5444; 2000000026)
        {
            ...
            dataitem(DataItem8078; "Packing List Header")//Table33001046)
            {
                DataItemTableView = SORTING("No.");
                RequestFilterFields = "No.";
                //ReqFilterHeading = 'Packing List Document';       //PCPL-25/030123
                ...
                dataitem(DataItem1535; "Packing List Package Details")//Table33001048)
                {
                    ...
                    column(net; "Net Wght. per Case")
                    {
                    }
                    column(gross; "Gross Wght. per Case")
                    {
                    }
                    // column(prodctdesc; ProductGroup.Description)
                    // {
                    // }  //PPCL-25/030123
                    column(LineNoGroup; "Line No.")
                    {
                    }
                    column(ItemNoGroup; "Item No.")
                    {
                    }
                    ...
                    // column(Packing_List_Header___Final_Destination_; "Final Destination")
                    // {
                    // }//PCPL-25/030123
                    column(LOCADDRESS; lOCATIONCODE.Address)
                    {
                    }
                    column(Tarewt; "Tare Weight Per Case")
                    {
                    }
                    ...
                    column(KindofPacking_PackingListPackageDetails; "Kind of Packing")
                    {
                    }
                    column(WeightUOM_PackingListPackageDetails; "Weight UOM")
                    {
                    }
                    ...
                    // column(FromTOPackg; (Marks))
                    // {
                    // }//PCPL-25/030123
                    column(ToPackg; "To Package No.")
                    {
                    }
                    column(FromPackg; "From Package No.")
                    {
                    }
                    ...
                    {
                        //DecimalPlaces = 2 : 5;    //PCPL-25/030123
                    }
                    ...
                    // column(Packing_List_Header___Order_Date_; "Order Date")
                    // {
                    // } //PCPL-25/030123
                    column(txtCompanyAddr_3_; txtCompanyAddr[3])
                    {
                    }
                    // column(Packing_List_Header___External_Document_No__; "External Document No.")
                    // {
                    // }    //PCPL-25/030123
                    ...
                    // column(Packing_List_Header___Posting_Date_; "Posting Date")
                    // {
                    // }    //PCPL-25/030123
                    column(txtCompanyAddr_1_; txtCompanyAddr[1])
                    {
                    }
                    // column(Packing_List_Header___No__; "No.")
                    // {
                    // }    //PCPL-25/030123
                    ...
                    column(decNetWeight; "Net Wght. per Case" * "No. Of Packages")
                    {
                        DecimalPlaces = 2 : 5;
                    }
                    column(decGrossWeight; "Gross Wght. per Case" * "No. Of Packages")
                    {
                        DecimalPlaces = 2 : 5;
                    }
                    column(intToPackageNo; "No. Of Packages")
                    {
                    }
                    column(totgross; "Tare Weight Per Case" * "No. Of Packages")
                    {
                    }
                    ...
                    begin
                        ...
                        IF "Line No." = 10000 THEN
                            ItemDesctext := ''//Marks  //PCPL-25/030123
                        ELSE
                            ItemDesctext := '';
                        ...
                        IF recItem.FINDFIRST THEN BEGIN
                            ...
                            //BEGIN
                            //IF ProductGroup.GET(recItem."Item Category Code", recItem."Product Group Code") THEN; //PCPL-25/030123
                            //END;
                        END;
                        CLEAR(Descr2);
                        PackingListLine.RESET;
                        PackingListLine.SETRANGE("Document No.", "Packing List No.");
                        ...
                        END ELSE BEGIN
                            IF recPackListPackageDetails.FIND('-') THEN
                                REPEAT
                                    ...
                                    //cduEximMgmt.fctUOMConversion(codWeightUOM, recPackListPackageDetails."Weight UOM", decNetWeightUOM); //PCPL-25/030123
                                    decGrossWeightUOM := recPackListPackageDetails."Gross Wght. per Case";
                                    //cduEximMgmt.fctUOMConversion(codWeightUOM, recPackListPackageDetails."Weight UOM", decGrossWeightUOM); //PCPL-25/030123
                        ...
                        //cduEximMgmt.fctTotalConsolidatePkgs("No.", "Incentive Type", "Claim DDB", intTotalConsolidatePkgs);   //PCPL-25/030123
                        recPackListPackageDetails.RESET;
                        recPackListPackageDetails.SETRANGE(recPackListPackageDetails."Packing List No.", "Packing List No.");
                        ...
                        IF ExtendedLinePrint = TRUE THEN BEGIN
                            ...
                            RecextendedLine.SETRANGE(RecextendedLine."No.", "Item No.");
                ...
                dataitem(FixedLay; 2000000026)
                {
                    ...
                    // dataitem(DataItem3405; 280)
                    // {
                    //     //DataItemLink = "No."=FIELD("Item No.");   //PCPL-25/030123
                    //     //DataItemLinkReference = "Packing List Package Details";  //PCPL-25/030123 
                    //     DataItemTableView = SORTING("No.");
                    //     column(Extended_Text_Line__Extended_Text_Line__Text; Text)
                    //     {
                    //     }
                ...
                begin
                    ...
                    IF Status = Status::Shipped THEN BEGIN
                        ...
                        // ShipmentMethod := SalesInvHeader."Vessel/Flight No."; //PCPL-25/030123
                    END ELSE BEGIN
                        SalesHeader.RESET;
                        SalesHeader.SETRANGE(SalesHeader."No.", "SO NO.");
                        IF SalesHeader.FINDFIRST THEN
                            BuyRefNo := SalesHeader."Buyer Reference No.";
                        //ShipmentMethod := SalesHeader."Vessel/Flight No.";    //PCPL-25/030123
                    END;
                    ...
                    // // fctPackingListSellTo(txtSellToCust, "Packing List Header");  //PCPL-25/030123
                    ...
                    //     fctPackingListBillTo(txtBillToCust, "Packing List Header");      //PCPL-25/030123

                    // IF recPorts.GET(Port) THEN txtPortName := recPorts."Port Name"; //PCPL-25/030123
                    // IF recPorts.GET("Port of Discharge") THEN txtPortofDischarge := recPorts."Port Name"; //PCPL-25/030123
                    ...
                    IF "Location Code" = '' THEN BEGIN
                        //IF recState.GET(recCompanyInfo.State) THEN    //PCPL-25/030123
                    ...
                    PackingListLine.RESET;
                    PackingListLine.SETRANGE(PackingListLine."Document No.", "No.");
                    IF PackingListLine.FINDSET THEN
                        REPEAT
    ...
    var
        ...
        recPackListPackageDetails: Record 50055;//"33001048";
        recBankAcc: Record 270;
        //recPorts: Record "33001050";  //PCPL-25/030123
        recPostCode: Record 225;
        recCountry: Record 9;
        recShipmentMethod: Record 10;
        cduFormatAddr: Codeunit 365;
        cduEximMgmt: Codeunit 50008;//"33001004";
        ...
        MfgDrugLic: Code[50];
        PackingListLine: Record 50053;//"33001047";
        quantity: Decimal;
        unitprice: Decimal;
        ...
        Country: Record 9;
        Remarks: Text[250];
        //ProductGroup: Record 5723;    //PCPL-25/030123
        ItemDesctext: Text;
    ...
    var
        lrecPackingListPackageDetails: Record 50055;//"33001048";
    begin
        CLEAR(decNetWght);
        CLEAR(decGrossWght);
        ...
        IF lrecPackingListPackageDetails.FIND('-') THEN
            REPEAT
                ...
                //cduEximMgmt.fctUOMConversion(codWeightUOM, lrecPackingListPackageDetails."Weight UOM", decNetWeightUOM);  //PCPL-25/030123
                decGrossWeightUOM := lrecPackingListPackageDetails."Gross Wght. per Case";
                //cduEximMgmt.fctUOMConversion(codWeightUOM, lrecPackingListPackageDetails."Weight UOM", decGrossWeightUOM);//PCPL-25/030123
    ...
    procedure fctPackingListSellTo(var PtxtAddrArray: array[8] of Text[80]; var PrecPackingList: Record 50054)//"33001046");
    begin
    ...
    procedure fctPackingListShptTo(var PtxtAddrArray: array[8] of Text[80]; var PrecPackingList: Record 50054)//"33001046");
    begin
        WITH PrecPackingList DO
            cduFormatAddr.FormatAddr(
    ...
    procedure fctPackingListBillTo(var PtxtAddrArray: array[8] of Text[80]; var PrecPackingList: Record 50054)//"33001046");
    begin
        WITH PrecPackingList DO
            cduFormatAddr.FormatAddr(
